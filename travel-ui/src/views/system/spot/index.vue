  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="景点名称" prop="name">
        <el-input v-model="queryParams.name" placeholder="请输入景点名称" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>

      <el-form-item label="地区信息" prop="region">
        <el-input v-model="queryParams.region" placeholder="请输入地区信息" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['system:spot:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['system:spot:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['system:spot:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['system:spot:export']">导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="spotList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="景点坐标" align="center" prop="location" />
      <el-table-column label="景点的描述" align="center" prop="description" />
      <el-table-column label="地区信息" align="center" prop="region" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="景点坐标" prop="location">
          <el-input v-model="form.location" placeholder="请输入景点坐标" />
        </el-form-item>
        <el-form-item label="景点的描述" prop="description">
          <el-input v-model="form.description" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="地区信息" prop="region">
          <el-input v-model="form.region" placeholder="请输入地区信息" />
        </el-form-item>
  ...
  data () {
    return {
      ...
      rules: {
        ...
        location: [
          { required: true, message: "景点坐标不能为空", trigger: "blur" }
        ],
        region: [
